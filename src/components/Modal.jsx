...
const Modal = ({ selectedItem }) => {
  ...
  useEffect(() => {
    if (selectedItem && selectedItem.type === 'pdf') {
      ...
      const fullText = `TRX REPRESENTA LA CULMINACIÓN DE UNA DÉCADA DE INVESTIGACIÓN EN ARQUITECTURA EXPERIMENTAL Y DISEÑO COMPUTACIONAL.
            ...
            <div className="w-full max-w-none">
              <div className="space-y-1 sm:space-y-4 px-2 sm:px-6">
                <div className="font-mono text-[9px] sm:text-xs leading-[1.3] sm:leading-tight uppercase" style={{ 
                  ...
                  {!isTyping && typedText && <span className="animate-pulse">_</span>}
                </div>
              </div>
            </div>
